...
import ru.valle.btc.CameraPreview;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (camera == null) {
            try {
                ...
                Toast.makeText(this, getString(R.string.error_open_camera) + "\n" + e.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
        ...
        public void onPreviewFrame(byte[] data, Camera camera) {
            ...
            if (result != 0) {
                ...
                for (Symbol sym : syms) {
                    ...
                    boolean validInput = decodedEntity != null && BTCUtils.verifyChecksum(decodedEntity);
                    if (validInput) {
